  ...
  var Popover = function () {
    ...
    _createClass(Popover, [{
      ...
      value: function open() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__helper_Responsive__["default"].matchesBreakpoint('lap-and-up') || this.options.noMobile) {
    ...
    _createClass(ProductSection, [{
      ...
      value: function _setupDeviceFeatures(event) {
        ...
        if (currentBreakpoint === 'phone' || currentBreakpoint === 'tablet') {
          ...
          if (this.slideshowImages && this.slideshowImages.length > 1 && this.slideshowNavDots) {
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  (function () {
    ...
    theme._ProductSection = __WEBPACK_IMPORTED_MODULE_2__sections__["ProductSection"]
